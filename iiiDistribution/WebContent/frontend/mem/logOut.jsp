...
<style type="text/css">
	.card{
     ...
     height: auto; 
     z-index: -100;  
     background: url(/BA106G4/frontend/images/bg.jpg) no-repeat;
...
<body>
		<div class="container">
			...
			<div id="coolDiv" style=" position: absolute; right: 10px; top:50px; ">
				<img  src="/BA106G4/frontend/images/IIICAR5.png" height="150"></a>
			</div>
			<div>
...
<video autoplay="autoplay" loop poster="<%=request.getContextPath()%>/frontend/images/bg.jpg" id="bgvid">
<%-- 	  <source src="<%=request.getContextPath()%>/frontend/images/bgvideo.webm" type="video/webm">  --%>
	  <source src="<%=request.getContextPath()%>/frontend/images/bgvideo.mp4" type="video/mp4"> 
  </video>
