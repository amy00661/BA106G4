...
<body>
    ...
    <br><br>
    <div id="introduction" >
	  <span class="head">編號</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="body" id="index1" style="border: 4px dotted blue;"></span>
	  <br>
	  <span class="head">車牌</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="body" id="plate1"></span>
	  <br>
	  <span class="head">緯度</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="body" id="latitude1"></span>
	  <br>
	  <span class="head">經度</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="body" id="longitude1"></span>
	  <br>
	  <span class="head">速度</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="body" id="speed1"></span>
	  <br>
	  <span class="head">圖片</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="body" id="image1"></span>
	  <br>
    ...
    <script>
     ...
     $(document).ready(function(){
    	setInterval( haha , 4000);
      	haha();
    	function haha(){
	      $.ajax({
	        type:"post",
	        url :"<%=request.getContextPath()%>/ForMacJsonFromDbToUrl.do",
