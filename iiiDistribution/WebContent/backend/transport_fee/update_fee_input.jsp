...
<!-- 主要功能 -->
	<div>
	<form method="post" action="<%=request.getContextPath()%>/size/size.do" name="form">
	  <table id="tb" class="table table-sm">
       <thead class="thead-dark">
		<tr>
			<th width="175px"><input style="text-align:center;" type="text" name="size_id" class="form-control" id="inputSize" disabled="disabled"  value="${sizeVO.size_id }"></th>
			<th width="345px"><input style="text-align:center;" type="text" name="size_type" class="form-control" id="inputSize"   value="${sizeVO.size_type }"></th>
			<th width="190px"><input style="text-align:center;" type="text" name="size_price" class="form-control" id="inputSize"   value="${sizeVO.size_price }"></th>
			<th width="275px"><input style="text-align:center;" type="text" name="emp_id" class="form-control" id="inputSize" disabled="disabled"  value="${sizeVO.emp_id }"></th>
			<th width="470px"><input style="text-align:center;" type="text" name="size_updatetime" class="form-control" id="inputSize" disabled="disabled"  value="${sizeVO.size_updatetime }"></th>
			<th>
