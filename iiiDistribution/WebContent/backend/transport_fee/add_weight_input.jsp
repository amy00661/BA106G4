	...
	<form method="post" action="<%=request.getContextPath()%>/weight/weight.do" name="form">
	  <table id="tb" class="table table-sm">
       <thead class="thead-dark">
		<tr>
			<th width="175px"><input style="text-align:center;" type="text" name="weight_id" class="form-control" id="addWeight_id" disabled="disabled"></th>
			<th width="345px"><input style="text-align:center;" type="text" name="weight_type" class="form-control" id="addWeight_type"></th>
			<th width="190px"><input style="text-align:center;" type="text" name="weight_price" class="form-control" id="addWeight_price"></th>
			<th width="275px"><input style="text-align:center;" type="text" name="emp_id" class="form-control" id="addWeight_emp_id" disabled="disabled"  value="${weightVO.emp_id }"></th>
			<th width="470px"><input style="text-align:center;" type="text" name="weight_updateTime" class="form-control" id="addWeight_updateTime" disabled="disabled"  value="${weightVO.weight_updateTime}"></th>
			<th>
