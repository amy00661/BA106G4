...
<%
	WeightVO traVO = (WeightVO) request.getAttribute("weightVO");
%>
...
<!-- 主要功能 -->
	<div>
	<form method="post" action="<%=request.getContextPath()%>/weight/weight.do" name="form">
	  <table id="tb" class="table table-sm">
       <thead class="thead-dark">
		<tr>
			<th width="175px"><input style="text-align:center;" type="text" name="weight_id" class="form-control" id="inputWei" disabled="disabled"  value="${weightVO.weight_id}"></th>
			<th width="345px"><input style="text-align:center;" type="text" name="weight_type" class="form-control" id="inputWei"   value="${weightVO.weight_type }"></th>
			<th width="195px"><input style="text-align:center;" type="text" name="weight_price" class="form-control" id="inputWei"   value="${weightVO.weight_price }"></th>
			<th width="270px"><input style="text-align:center;" type="text" name="emp_id" class="form-control" id="inputWei" disabled="disabled"  value="${weightVO.emp_id }"></th>
			<th width="470px"><input style="text-align:center;" type="text" name="weight_updateTime" class="form-control" id="inputWei" disabled="disabled"  value="${weightVO.weight_updateTime }"></th>
			<th><input type=hidden name="action" value="update">
				<input type=hidden name="weight_id" value="${weightVO.weight_id}">
				<input type=hidden name="emp_id" value="${weightVO.emp_id }">
