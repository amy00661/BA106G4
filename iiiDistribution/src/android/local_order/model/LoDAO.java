...
//	private static final String INSERT_ONE_WITH_ORDERID = "INSERT INTO LOCAL_ORDER(LOCAL_ORDER_ID, EMP_ID, ORDER_ID, LOCAL_ORDER_UPDATETIME) VALUES ('L_O'||LPAD(TO_CHAR(local_order_seq.NEXTVAL), 3, '0'), ?, ?, SYSDATE)";
